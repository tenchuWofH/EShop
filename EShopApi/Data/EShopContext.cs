        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Product>().HasData(
                new Product
                {
                    ...
                    ProductId = Guid.Parse("d28888e9-2ba9-473a-a40f-e38cb54f9b35"),
                    Title = "The Winds of Winter",
                    Description = "The Product that seems impossible to write."
                },
                new Product
                {
                    ...
                    Description = "A Game of Thrones is the first novel in A Song of Ice and Fire, a series of fantasy novels by American Product George R. R. ... In the novel, recounting events from various points of view, Martin introduces the plot-lines of the noble houses of Westeros, the Wall, and the Targaryens."
                },
                new Product
                {
                ...
                new Product
                {
                    ...
                    ProductId = Guid.Parse("24810dfc-2d94-4cc7-aab5-cdf98b83f0c9"),
                ...
                new Product
                {
                    ...
                    ProductId = Guid.Parse("2902b665-1190-4c70-9915-b9c2d7680450"),
